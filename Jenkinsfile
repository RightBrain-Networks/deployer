    ...
    stage('GitHub Release')
    {
      ...
      steps
      {
        ...
        script
        {
          ...
          releaseId = createGitHubRelease("RightBrain-Networks/deployer", "TEST: v${env.SEMVER_RESOLVED_VERSION}", "feature/releaseAsFunctions", "${env.SEMVER_RESOLVED_VERSION}", "true", "deployer/gitHub/releaseKey")
